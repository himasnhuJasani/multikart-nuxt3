  ...
  <div>
      ...
      <div class="setting_box_body">
        ...
        <div class="setting-body">
                ...
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    ...
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/fashion' }" class="btn new-tab-btn"
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>tools</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/tools' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>pets</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/pets' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>jewellery</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/jewellery' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Fashion</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/fashion-2' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Fashion</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/fashion-3' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Shoes</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/shoes' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Bags</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/bags' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Watch</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/watch' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Kids</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/kids' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Flower</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/flower' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Vegetables</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/vegetables' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Beauty</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/beauty' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Electronic</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/electronics-1' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>Furniture</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/shop/furniture' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>right sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/right-sidebar' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>no sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/no-sidebar' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>popup</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/sidebar-popup' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>metro</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/metro' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>full width</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/full-width' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>three grid</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/three-grid' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>six grid</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/six-grid' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects mb-0">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>list view</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/collection/list-view' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>four image</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/four-image' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>left sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/sidebar/1' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>right sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/sidebar/right-sidebar' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>no sidebar</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/sidebar/no-sidebar' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>bundle</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/bundle-product' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>left image</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/thumbnail-image/left-image' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>right image</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/thumbnail-image/right-image' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>image outside</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/thumbnail-image/image-outside' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>3-col left</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/three-column/thumbnail-left' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>3-col right</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/three-column/thumbnail-right' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-12 text-center demo-effects">
                <div class="set-position">
                  ...
                  <div class="demo-text">
                    <h4>3-col bottom</h4>
                    <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                      <nuxt-link :to="{ path: '/product/three-column/thumbnail-bottom' }" class="btn new-tab-btn"
                        target="_blank">Preview</nuxt-link>
                    </div>
                  </div>
                </div>
          ...
          <div class="setting-contant" :class="{ opensubmenu: isActive('color option') }">
            <ul class="color-box">
              <li>
                <input id="colorPicker1" type="color" :value="layout.config.color" name="Background"
          ...
          <div class="setting-contant" :class="{ opensubmenu: isActive('rtl') }">
            <ul class="setting_buttons">
              <li :class="layoutType == 'ltr' ? 'active' : ''" id="ltr_btn">
                <a href="javascript:void(0)" @click="customizeLayoutType('ltr')" class="btn setting_btn">LTR</a>
              </li>
              <li :class="layoutType == 'rtl' ? 'active' : ''" id="rtl_btn">
          ...
          <div class="buy_btn">
            ...
            <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
              target="_blank" class="btn btn-block purchase_btn">
              <img src="../../public/images/icon/angular.png" alt class="img-fluid" /> Multikart Angular
            </a>
            <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
              target="_blank" class="btn btn-block purchase_btn">
              <img src="../../public/images/icon/react.png" alt class="img-fluid" /> Multikart React
            </a>
            <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
              target="_blank" class="btn btn-block purchase_btn">
              <img src="../../public/images/icon/shopify.png" alt class="img-fluid" /> Multikart Shopify
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="addcart_btm_popup" id="fixed_cart_icon">
      <a href="#" class="fixed_cart">
        <i class="fa fa-clone" aria-hidden="true" title="Configuration" data-bs-toggle="modal"
          data-bs-target="#bv-modal-example"></i>
      </a>
    </div>
    <!-- Config Popup -->

    <div class="modal fade bd-example-modal-lg theme-modal" id="bv-modal-example" aria-hidden="true" tabindex="-1"
      role="dialog" aria-labelledby="modal-cartLabel">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content quick-view-modal">
          <div class="modal-body">
            <div class="bg-white position-relative">
              <button class="close btn-close" type="button"><span>×</span></button>
