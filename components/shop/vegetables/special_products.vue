            ...
            <div class="col-md-4">
              <div class="theme-card center-align">
                <div class="offer-slider">
                  <div class="sec-1">
                    <div class="product-box2" v-for="(product, index) in products.slice(0, 2)" :key="index">
                      <div class="media">
                ...
                <div class="offer-slider">
                  <div>
                    <div class="product-box product-wrap" v-for="(product, index) in products.slice(2, 3)" :key="index">
                      <productBox6 @opencartmodel="showCartModal" @showCompareModal="showcomparemodal"
                    ...
                    <div class="product-box2" v-for="(product, index) in products.slice(3, 5)" :key="index">
                      <div class="media">
                        ...
                        <div class="media-body align-self-center">
                          ...
                          <ul class="color-variant">
                            <li v-for="(variant, index) in Color(product.variants)" :key="index">
                              <a v-on:click="productColorchange(variant, product)" :class="[variant]"
...
<script>
import productBox6 from '../../product-box/product-box6'
export default {
  props: ['products'],
  components: {
    productBox6
