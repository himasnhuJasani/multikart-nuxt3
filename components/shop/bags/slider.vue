    ...
    <div class="slide-1 home-slider">
      <swiper  loop=true :navigation="true" :modules="modules" :slidesPerView="auto" class="swiper-wrapper">
        <swiper-slide class="swiper-slide" v-for="(item, index) in items" :key="index">
          <div class="home text-center p-center" :class="item.alignclass"
                ...
                <div class="col">
                  <div class="slider-contain">
                    <div>
                      <h4>{{ item.title }}</h4>
                      <h1>{{ item.subtitle }}</h1>
                      <nuxt-link :to="{ path: '/collection/left-sidebar' }" class="btn btn-solid">Save up to 50%
                        off</nuxt-link>
                    </div>
                  </div>
                </div>
...
export default {
  data() {
    return {
      ...
      items: [
        {
          imagepath: ('/images/home-banner/7.jpg'),
          title: 'summer sale',
          subtitle: 'the bag',
          alignclass: 'p-center'
        },
        {
          imagepath: ('/images/home-banner/8.jpg'),
          title: 'summer sale',
          subtitle: 'the bag',
          alignclass: 'p-center'
        },
