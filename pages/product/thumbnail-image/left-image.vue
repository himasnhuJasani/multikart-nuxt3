<template>
    <div>
                        ...
                        <div class="col-lg-1 col-sm-2">
                            <div class="row">
                                <div class="col-12 p-0 slider-nav-images">
                                    <swiper :breakpoints="swiperOption.breakpoints" :slidesPerView="2"
                                        :spaceBetween="20" class="swiper-wrapper slider-right-nav">
                                        <swiper-slide class="swiper-slide" v-for="(product, index) in getDetail.images"
                                            :key="index" :class="slideId == index ? 'product-slider-active' : ''">
                                            <img :src="getImgUrl(product.src)" :id="product.image_id"
                                                class="img-fluid bg-img" alt="product.alt" @click="slideTo(index)" />
                                        </swiper-slide>
                                    </swiper>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 col-sm-10 order-up">
        ...
        <div class="modal fade bd-example-modal-lg theme-modal" id="modal-1" aria-hidden="true" tabindex="-1"
                        ...
                        <div class="modal-body p-0">
                            <div class="bg-white position-relative">
                                <div class="modal-header position-relative">
                                    <h5 class="m-0">{{ getDetail.title }}</h5>
                                    <button class="close btn-close background-none" type="button"
...
export default {
    components: {
        Breadcrumbs,
        Timer,
        relatedProduct, Swiper, SwiperSlide
    },
