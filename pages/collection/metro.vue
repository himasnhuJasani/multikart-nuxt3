            ...
            <div class="collection-content col">
              <div class="page-main-content">
                ...
                <div class="collection-product-wrapper">
                  <div class="section-t-space portfolio-section metro-section port-col row">
                    <MasonryWall :items="products" :padding="16" :column-width="300" :gap="15"
                        ...
                        <div class="product-box">
                          <div class="img-wrapper">
                            ...
                            <div class="cart-info cart-wrap">
                              ...
                              <a href="javascript:void(0)" title="Comapre" @click="showCoampre(item)" variant="primary">
                          ...
                          <div class="product-detail">
                            ...
                            <h4>{{ curr.symbol }}{{ item.price * currency.curr }}</h4>
                          </div>
                        </div>
                      </template>
                    </MasonryWall>
