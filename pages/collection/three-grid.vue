                          ...
                          <div class="col-12">
                            <div class="product-filter-content">
                              ...
                              <div class="collection-grid-view">
                                <ul>
                                  <li>
                                    <img src='@/public/images/icon/2.png' @click="grid2()"
                                      class="product-2-layout-view" />
                                  </li>
                                  <li>
                                    <img src='@/public/images/icon/3.png' @click="grid3()"
                                      class="product-3-layout-view" />
                                  </li>
                                  <li>
                                    <img src='@/public/images/icon/4.png' @click="grid4()"
                                      class="product-4-layout-view" />
                                  </li>
                                  <li>
                                    <img src='@/public/images/icon/6.png' @click="grid6()"
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="text-center section-t-space section-b-space" v-if="filterProduct.length == 0">
                              <img :src='"@/public/images/empty-search.jpg"' class="img-fluid" alt />
