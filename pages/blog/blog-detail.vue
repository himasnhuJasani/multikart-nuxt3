      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 blog-detail">
            <img src='/images/about/about-us.jpg' class="img-fluid" alt="blog" />
        ...
        <div class="row section-b-space blog-advance">
          <div class="col-lg-6">
            <div>
              <img src='../../public/images/blog/10.jpg' class="img-fluid" alt="blog-image" />
            </div>
          </div>
          <div class="col-lg-6">
            <div>
        ...
        <div class="row section-b-space">
          <div class="col-sm-12">
            <ul class="comment-section">
              <li>
                <div class="media">
                  <img src='/images/avtar.jpg' alt="Generic placeholder image" />
              ...
              <li>
                <div class="media">
                  <img src='/images/2.jpg' alt="Generic placeholder image" />
                  <div class="media-body">
                    <h6>
                      Mark Jecno
                      <span>( 12 Jannuary 2018 at 1:30AM )</span>
              ...
              <li>
                <div class="media">
                  <img src='/images/20.jpg' alt="Generic placeholder image" />
                  <div class="media-body">
                    <h6>
                      Mark Jecno
                      <span>( 12 Jannuary 2018 at 1:30AM )</span>
