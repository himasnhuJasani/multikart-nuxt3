<template>
  <div>
    ...
    <section class="portfolio-section portfolio-padding pt-0 port-col zoom-gallery">
      <div class="container-fluid">
       <div class="masonry-container isotopeContainer row">
         
            <MasonryWall :items="filteredImages" :ssr-columns="1" :padding="16"  :column-width="300" :gap="15" class="col-sm-2 isotopeSelector item">
