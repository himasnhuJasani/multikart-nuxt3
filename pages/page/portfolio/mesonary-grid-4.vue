<template>
  <div>
    <Breadcrumbs title="mesonary 4 grid" />
    ...
    <section class="portfolio-section portfolio-padding pt-0 port-col zoom-gallery">
      <div class="container">
        <no-ssr>
          ...
          >
          <MasonryWall :items="filteredImages" :ssr-columns="1" :padding="16"  :column-width="300" :gap="15" class="col-sm-3 isotopeSelector item">
